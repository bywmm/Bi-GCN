...
from function import binary_linear, binary_linear_scalar, bst, sbst, sbst0

class BinaryLinear(nn.Module):
    def __init__(self, in_features, out_features, bias=True, scalar=False):
...
class BinActive(nn.Module):
    def __init__(self, scalar=False, dim=1):
