...
class Net(torch.nn.Module):
    def __init__(self, dataset):
        ...
        for i in range(args.layers):
            ...
            # bns.append(torch.nn.BatchNorm1d(out_channels, affine=False))
            convs.append(BiGCNConv(in_channels, out_channels, cached=True, bi=True))
            # bns.append(torch.nn.BatchNorm1d(in_channels, affine=False))
...
# root = 'D:/dataset/Planetoid'
root = '/home/wangjunfu/dataset/graph/Planetoid'
# root = '/home/dingsd/junbb/dataset/Planetoid'
dataset = Planetoid(root, args.dataset)
# dataset = Planetoid(root, 'NELL.0.001')
...
run(dataset, Net(dataset), args.runs, args.epochs, args.lr, args.weight_decay,
    args.early_stopping, args.plot_loss, permute_masks)
